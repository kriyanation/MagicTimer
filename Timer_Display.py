...
class TimerDisplay(tk.Frame):
    def __init__(self,parent,bg=BACKGROUND_DARK,*args,**kwargs):
        ...
        self.image_plus = PhotoImage(file="signs_plus_real.png")
        self.image_minus = PhotoImage(file="signs_minus_real.png")
        self.image_start = PhotoImage(file="power-button.png")
    ...
    def run_timer(self):
        ...
        if (int(self.minutes_val.get()) == 0):
            ...
            sound = pygame.mixer.Sound("beep-12.wav")
            sound.play()
            self.timer_running_flag = 0
            return
